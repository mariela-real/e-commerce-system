...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="<?php echo e(asset('css/mission_vision.css')); ?>">
</head>
<body>
    ...
    <div class="content__mission">
        ...
        <div class="mission_vision">
            ...
            <div class="vision__logo">
                <img src="<?php echo e(asset('img/lupa.png')); ?>" alt="">
        ...
        <div class="mission_mission">
            ...
            <div class="mission__logo">
                <img src="<?php echo e(asset('img/idea.png')); ?>" alt="">
    ...
    <div class="content__values">
        ...
        <div class="values_list">   
              <div class="values_item">
                    <img src="<?php echo e(asset('img/transparencia.png')); ?>" alt="">
                    <h1>
                        Transparencia
                    </h1>
                    <p>
              ...
              <div class="values_item">
                    <img src="<?php echo e(asset('img/proactividad.png')); ?>" alt="">
                    <h1>
                        Proactividad
                    </h1>
                    <p>
              ...
              <div class="values_item">
                    <img src="<?php echo e(asset('img/honestidad.png')); ?>" alt="">
                    <h1>
                        Honestidad
                    </h1>
                    <p>
...
<?php echo $__env->make('navbar.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\poolg\OneDrive\Documentos\EMBATE\EMBATETION\resources\views/mission_vision/mission_vision.blade.php ENDPATH**/ ?>