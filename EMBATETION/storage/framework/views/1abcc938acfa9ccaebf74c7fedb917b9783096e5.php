        ...
        <div class="form-row">    
          <div class="col-12">
            <div class="input-group mb-3">
              ...
              autofocus value="<?php echo e(old('usuario')); ?>"/>
            </div>
            <?php if($errors->has('usuario')): ?>
               <span class="error text-danger" for="input-usuario"><?php echo e($errors->first('usuario')); ?></span>
            <?php endif; ?>  
            <br>        
          </div>
          ...
          <div class="col-12">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                ...
                value="<?php echo e(old('contrasenia')); ?>" />
            ...
            <?php if($errors->has('contrasenia')): ?>
                <span class="error text-danger" for="password"><?php echo e($errors->first('contrasenia')); ?></span>
            <?php endif; ?>
          </div>
...
</script><?php /**PATH C:\Users\poolg\OneDrive\Documentos\EMBATE\EMBATETION\resources\views/login/form_login.blade.php ENDPATH**/ ?>