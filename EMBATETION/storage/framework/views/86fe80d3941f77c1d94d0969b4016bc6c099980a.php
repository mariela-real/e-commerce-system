...
<body>
      ...
      <div class="swiper">
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <img src="<?php echo e(asset('img/embate_1.jpg')); ?>" alt="">
          ...
          <div class="swiper-slide">
            <img src="<?php echo e(asset('img/embate_4.jpg')); ?>" alt="">
          ...
          <div class="swiper-slide">
            <img src="<?php echo e(asset('img/embate_collage.png')); ?>" alt="">
            <div class="text-overlay left">
  ...
  <script type="text/javascript" src="<?php echo e(asset('js/about.js')); ?>"></script>
</body>

</html>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('navbar.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\poolg\OneDrive\Documentos\EMBATE\EMBATETION\resources\views/about/about.blade.php ENDPATH**/ ?>