...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="<?php echo e(asset('css/pre_incubation.css')); ?>">
</head>
<body>
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/pre_incubation.js')); ?>"></script>
</body>
</html>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('navbar.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\poolg\OneDrive\Documentos\EMBATE\EMBATETION\resources\views/pre_incubation/pre_incubation.blade.php ENDPATH**/ ?>