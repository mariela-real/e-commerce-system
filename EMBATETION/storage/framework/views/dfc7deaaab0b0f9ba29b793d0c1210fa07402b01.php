...
<section id="split-screen">
        <div class="left">
           <img src="img/OSOS_LOGO_1.png" />
            ...
            <?php echo $__env->make('advice.schedule_advice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <div class="right">
            <h2>
...
<?php /**PATH C:\Users\poolg\OneDrive\Documentos\EMBATE\EMBATETION\resources\views/advice/advice.blade.php ENDPATH**/ ?>