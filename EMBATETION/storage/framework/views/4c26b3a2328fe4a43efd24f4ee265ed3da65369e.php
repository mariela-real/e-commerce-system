...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="<?php echo e(asset('css/incubation.css')); ?>">
</head>
<body>
    <!-- content__Incubation controla toda la pagina de rpe encubacion-->
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/incubation.js')); ?>"></script>
...
<?php echo $__env->make('navbar.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\poolg\OneDrive\Documentos\EMBATE\EMBATETION\resources\views/incubation/incubation.blade.php ENDPATH**/ ?>